...
// Effects sourced from 2024 Player's Handbook (xPHB)
const CONDITION_EFFECTS: Record<string, string[]> = {
  Blinded: [
    "Can't see; automatically fail any ability check requiring sight.",
  ...
  Grappled: [
    ...
    'The grappler can drag or carry you when it moves (costs 1 extra ft per ft unless you are Tiny or 2+ sizes smaller).',
  ],
  Incapacitated: [
  ...
  Invisible: [
    ...
    "Not affected by effects requiring sight of you; worn/carried equipment is also concealed.",
    'Attack rolls against you have disadvantage; your attack rolls have advantage (unless the attacker can see you).',
  ],
  Paralyzed: [
    ...
    'Any hit is a critical hit if the attacker is within 5 ft.',
  ],
  Petrified: [
    'Transformed into a solid inanimate substance; weight ×10; cease aging.',
    'Have the Incapacitated condition.',
    "Speed is 0 and can't increase.",
    'Automatically fail STR and DEX saving throws.',
    'Attack rolls against you have advantage.',
  ...
  Prone: [
    'Movement options: crawl, or spend half your Speed to stand up and end the condition.',
    'Your attack rolls have disadvantage.',
    'Attacks against you have advantage within 5 ft; disadvantage beyond 5 ft.',
  ],
  Restrained: [
    "Speed is 0 and can't increase.",
    'Attack rolls against you have advantage; your attack rolls have disadvantage.',
  ...
  Unconscious: [
    'Have the Incapacitated and Prone conditions; drop held items; remain Prone when condition ends.',
    "Speed is 0 and can't increase.",
